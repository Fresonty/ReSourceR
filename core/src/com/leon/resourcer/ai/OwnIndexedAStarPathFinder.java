 ...
 *
 * @author davebaol */
public class OwnIndexedAStarPathFinder<N> implements PathFinder<N> {
    ...
    public OwnIndexedAStarPathFinder (IndexedGraph<N> graph) {
        this(graph, false);
    }

    @SuppressWarnings("unchecked")
    public OwnIndexedAStarPathFinder (IndexedGraph<N> graph, boolean calculateMetrics) {
        this.graph = graph;
    ...
    protected void search (N startNode, N endNode, Heuristic<N> heuristic) {
        ...
        do {
            ...
            System.out.println(current.node == endNode);
            if(current.node == endNode) {
    ...
    /** A class used by {@link OwnIndexedAStarPathFinder} to collect search metrics.
     *
     * @author davebaol */
